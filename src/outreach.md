...
Curious how regression-based ERP analysis actually works in practice?
This page collects video material about Unfold ecosystemfrom around the internet — talks, workshops, live coding sessions, and so on.

## Unfold workshop (2025)
This workshop walks you through regression-based ERP analysis with Unfold.jl — from the basic ideas to hands-on modeling and visualization.
...
In “The Unfold Family: Ecosystem for rERP-EEG analyses”, Benedikt Ehinger presents a toolbox ecosystem for regression-based time-series analysis, simulation, and visualization — centered on EEG, but flexible enough for pupil, skin conductance, and beyond.
